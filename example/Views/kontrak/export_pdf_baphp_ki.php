...
<body>
    <div class="header-img-container" style="text-align: center; margin-bottom: 10px;">
        <img src="<?= base_url() ?>public/img/logo_kop_jl_bakti.png" class="header-img" alt="Kop Surat" style="width: 100%; max-height: 120px; object-fit: contain;">
    </div>
    ...
    <div class="text-justify mb-2">
        Pada hari ini, tanggal <?= $tanggal_pemeriksaan; ?>, telah dilaksanakan pemeriksaan hasil pekerjaan, dengan ini telah mengadakan penelitian dan pemeriksaan antara konsultan perencanaan dan pejabat penandatangan kontrak, dan tim pendukung atas Pekerjaan <b><?= htmlspecialchars($data->nama_pekerjaan, ENT_QUOTES, 'UTF-8'); ?></b>.
    </div>
