...
<body>
    ...
    <div class="doc-number">
        ...
        Paket Pekerjaan Konsultan Individual Team Leader<br>
    ...
    <div class="content">
        ...
        <table class="info-table">
            <tr>
                ...
                <td class="sep-col">:</td>
                <td>Nurhidayat Nugroho, S.Ars.</td>
            </tr>
            <tr>
                <td class="label-col">NIP</td>
                <td class="sep-col">:</td>
                <td>199012212018021001</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="sep-col">:</td>
                <td>Jalan Bakti, Ruko Komplek Perumahan Mutiara Asri Garden, Kel. Sidomulyo Timur, Kec. Marpoyan Damai</td>
            </tr>
        </table>

        <div class="legal-text">
            Yang bertindak untuk dan atas nama*) Pemerintah Indonesia c.q. Kementerian Pekerjaan Umum c.q. Direktorat Jenderal Prasarana Strategis c.q. Satuan Kerja Pelaksanaan Prasarana Strategis Riau berdasarkan Surat Keputusan Menteri Pekerjaan Umum Nomor: 397/KPTS/M/2025 Tanggal 26 Maret 2025 Tentang Perubahan Atas Keputusan Menteri Pekerjaaan Umum Nomor: 3220/KPTS/M/2024 Tentang Pengangkatan Atasan/Atasan Langsung/Pembantu Atasan Langsung Kuasa Pengguna Anggaran/Barang dan Pejabat Perbendaharaan Satuan Kerja di Lingkungan Direktorat Jenderal Prasarana Strategis, Kementerian Pekerjaan Umum<br>
            selanjutnya disebut <span class="bold">Pejabat Penandatanganan Kontrak;</span>
        </div>

        <div class="legal-text">
            Berdasarkan SPK Nomor: <?= $kontrak->nomor_kontrak; ?> Tanggal <?= $kontrak->tanggal_kontrak; ?>, Bersama ini memerintahkan:
        </div>
        ...
        <table class="list-table">
            <tr>
                ...
                <td class="sep-col">:</td>
                <td>Konsultan Individual Team Leader</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="3">Waktu Penyelesaian selama (90) hari kalender dan pekerjaan harus sudah selesai pada tanggal 13 Juli 2025;</td>
            </tr>
            <tr>
        ...
        <table class="signature-table">
            <tr>
                <td>
                    ...
                    <div class="sig-name">Nurhidayat Nugroho, S.Ars</div>
                    <div class="sig-nip">NIP. 199012212018021001</div>
                </td>
                ...
                <td>
                    ...
                    <div class="sig-name">Ade Putra. ST.</div>
                    <div class="sig-nip">Team Leader</div>
                </td>
            </tr>
        </table>
    </div>
