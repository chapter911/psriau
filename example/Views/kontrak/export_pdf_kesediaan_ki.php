...
<body>
    ...
    <div class="text-justify mb-1">
        Dengan ini menyatakan bahwa saya bersedia untuk melaksanakan pekerjaan jasa <b>Konsultan Individual</b> sesuai dengan usulan jadwal penugasan saya dari bulan <?= bulan_tahun_indonesia($data->tanggal_awal); ?> sampai dengan bulan <?= bulan_tahun_indonesia($data->tanggal_akhir); ?> dengan posisi sebagai <b>Konsultan Individual <?= ucwords(strtolower($data->jabatan)); ?></b>.
    </div>
    ...
    <div class="signature-block">
        <div>Pekanbaru, <?= tanggal_indonesia($data->tanggal_surat_penawaran); ?></div>
