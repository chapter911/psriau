...
<body>
    ...
    <table class="header-table">
        <tr>
            ...
            <td align="right" width="120">Pekanbaru, <?= tanggal_indonesia($data->tanggal_sppbj); ?></td>
        </tr>
        <tr>
            <td>Lampiran</td>
            <td>:</td>
    ...
    <div class="mb-1">
        ...
        Di -<br>
        <div class="ml-2">
            <?= htmlspecialchars($data->alamat, ENT_QUOTES, 'UTF-8'); ?>
        </div>
    </div>
        ...
        <table style="width: 100%; border-collapse: collapse;">
            <tr>
                ...
                <td class="text-justify">
                    ...
                    <b><u>Konsultan Individual <?= htmlspecialchars($jabatan, ENT_QUOTES, 'UTF-8'); ?></u><br/><?= htmlspecialchars($data->nama_paket, ENT_QUOTES, 'UTF-8'); ?></b>
                </td>
            </tr>
        </table>
    </div>
    ...
    <div class="text-justify content-div">
        Dengan ini kami beritahukan bahwa penawaran Saudara nomor: <?= htmlspecialchars($data->nomor_surat_penawaran, ENT_QUOTES, 'UTF-8'); ?> tanggal <?= tanggal_indonesia($data->tanggal_surat_penawaran); ?> perihal Penawaran Administrasi Pekerjaan Tenaga Penunjang Dokumentasi dan Publikasi dengan nilai penawaran setelah dilakukan klarifikasi dan negosiasi teknis dan biaya oleh Pejabat Pengadaan barang dan Jasa Kegiatan Pengadaan Barang / Jasa Pada Satuan Kerja Pelaksanaan Prasarana Strategis Riau Tahun Anggaran <?= $data->tahun_anggaran; ?> sebesar Rp. <?= number_format($data->total_penawaran, 0, ",", "."); ?>,- (<?= htmlspecialchars($total_penawaran_terbilang, ENT_QUOTES, 'UTF-8'); ?>) termasuk PPH pasal 21, telah ditetapkan sebagai pemenang oleh Pejabat Pengadaan barang dan Jasa Kegiatan Pengadaan Barang / Jasa Pada Satuan Kerja Pelaksanaan Prasarana strategis Riau Tahun Anggaran <?= $data->tahun_anggaran; ?>.
    </div>

    <div class="text-justify content-div">
        Selanjutnya kami menunjuk Saudara untuk melaksanakan pekerjaan <b><u>Konsultan Individual <?= htmlspecialchars($jabatan, ENT_QUOTES, 'UTF-8'); ?></u></b>, dan meminta Saudara untuk menandatangani Surat Perjanjian setelah dikeluarkannya SPPBJ ini sesuai dengan ketentuan dalam Dokumen Pemilihan.
    </div>
