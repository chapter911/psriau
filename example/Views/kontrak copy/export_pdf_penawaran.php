...
<head>
    ...
    <style>
        ...
        @page {
            margin: 2cm; /* Margin dikurangi untuk lebih banyak ruang */
            size: A4;
        }
        ...
        body {
            ...
            font-size: 12pt;
            line-height: 1.1; /* Sedikit dikurangi untuk menghemat ruang */
            color: #000;
        }
        ...
        .meta-table {
            ...
            margin-bottom: 15px; /* Mengurangi margin bawah */
            page-break-inside: avoid; /* Hindari pecah halaman di dalam tabel ini */
        }
        .meta-table td {
            vertical-align: top;
            padding: 1px 0;
        ...
        p {
            text-align: justify;
            margin: 0 0 10px 0; /* Mengurangi margin bawah */
        }
        ...
        .signature-block {
            ...
            float: right;
            text-align: center;
            page-break-inside: avoid; /* Mencegah blok tanda tangan pecah halaman */
        }
        .signer-name {
            font-weight: bold;
            text-decoration: underline;
            margin-top: 60px; /* Mengurangi ruang untuk tanda tangan */
        }
...
<body>
    ...
    <div class="clearfix">
        <div class="signature-block">
            Tenaga Penunjang<br>Dokumentasi dan Publikasi<br>
