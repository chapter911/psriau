...
$routes->group('admin', ['filter' => 'auth:admin,editor'], static function ($routes): void {
	...
	$routes->get('tutorial', 'Admin\\Tutorial::index');
	...
	$routes->get('pengaturan/application/database-tables', 'Admin\Setting::databaseTables');
	...
	$routes->get('master/pegawai/export-pdf', 'Admin\Pegawai::exportPdf');
