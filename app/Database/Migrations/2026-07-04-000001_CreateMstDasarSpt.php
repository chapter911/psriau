...
class CreateMstDasarSpt extends Migration
{
    public function up()
    {
        $db = $this->db;
        ...
        $this->forge->createTable('mst_dasar_spt', true);
        ...
        $this->ensureLv2Menu($masterLv1Id, 'Dasar SPT', 'admin/master/dasar-spt', 'far fa-circle');
    }
    ...
    public function down()
    {
        ...
        // 1. Drop table
        $this->forge->dropTable('mst_dasar_spt', true);
        ...
        $row = $db->table('menu_lv2')
            ->select('id')
            ->where('LOWER(link)', 'admin/master/dasar-spt')
            ->get()
            ->getRowArray();
