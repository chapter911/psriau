...
$syarat_umum = $syarat_umum ?? (object) [
    'laporan' => '',
    'hasil' => '',
...
<head>
    ...
    <style>
        ...
        /* Cover khusus untuk menutupi footer paraf di halaman pertama */
        .first-page-footer-blocker {
            position: absolute;
            bottom: -3cm;
            /* Masuk ke area margin bawah */
            left: 0;
            width: 120%;
            height: 4cm;
            /* Tinggi cukup untuk menutupi area footer */
            background: #fff;
            z-index: 20000;
            /* Harus lebih tinggi dari .footer-paraf (9999) */
        }
    </style>
</head>
...
<body>
        ...
        <div class="first-page-footer-blocker"></div>

        <div class="header-img-container">
            <?= kop_surat_img_tag('header-img', '', 'Kop Surat', isset($data->kop_surat_id) ? (int) $data->kop_surat_id : null); ?>
        </div>

        <!-- COVER PAGE -->
        <div style="text-align: center; margin-top: 3cm; position: relative; z-index: 10;">
            <div class="text-bold" style="font-size: 16pt;">SURAT PERJANJIAN KERJA (SPK)</div>
            <div class="text-bold" style="font-size: 16pt;">(TENAGA PENUNJANG)</div>
            <br><br>
            <div class="text-bold" style="font-size: 11pt;">NOMOR : <?= $data->nomor_kontrak; ?></div>
            <div class="text-bold" style="font-size: 11pt;">TANGGAL : <?= tanggal_indonesia($data->tanggal_kontrak); ?>
            </div>
            <br><br><br>
            <div class="text-bold" style="font-size: 12pt;">ANTARA</div>
            <br><br>
            <div class="text-bold" style="font-size: 14pt; text-transform: uppercase;">SATUAN KERJA
                PELAKSANAAN<br>PRASARANA
                STRATEGIS RIAU</div>
            <br><br><br>
            <div class="text-bold" style="font-size: 12pt;">DENGAN</div>
            <br><br>
            <div class="text-bold" style="font-size: 14pt; text-transform: uppercase;"><?= $data->nama; ?></div>
            <br><br>
            <div class="text-bold" style="font-size: 12pt;">PEKERJAAN</div>
            <br><br>
            <div class="text-bold" style="font-size: 14pt; text-transform: uppercase;">KONSULTAN
                INDIVIDUAL<br><?= $data->jabatan; ?></div>
            <br><br><br><br><br><br>
            <div class="text-bold text-underline" style="font-size: 14pt; text-transform: uppercase;">TAHUN ANGGARAN
                <?= $data->tahun_anggaran; ?>
            </div>
        </div>
        ...
        <table class="main-table">
            ...
            <tr>
                ...
                <td class="col-content">
                    ...
                    <div class="text-justify" style="margin-top: 5px; font-size: 9pt;">
                        ...
                        <?= tanggal_indonesia($data->tanggal_surat_keputusan_menteri); ?> Tentang Perubahan Atas
                        Keputusan
                        Menteri Pekerjaaan Umum Nomor: <?= $data->nomor_perubahan_keputusan_menteri; ?> Tentang
                        Pengangkatan
            ...
            <tr>
                <td class="col-header">PAKET PENGADAAN:<br><span style="font-weight: normal;">Konsultan
                        Individual<br><?= $data->jabatan; ?></span></td>
                <td class="col-content">
            ...
            <tr>
                <td colspan="2" class="col-content text-justify">
                    ...
                    <strong><?= $data->nomor_dipa; ?> Tanggal <?= tanggal_indonesia($data->tanggal_dipa); ?></strong>
                    Tahun
        ...
        <table class="main-table">
            <tr>
                <td colspan="2">
                    ...
                    <ol style="margin-top: 0; padding-left: 20px; margin-bottom: 5px;">
                        <li>Pembayaran untuk Kontrak ini Dilakukan ke <strong><?= $data->bank_nama; ?></strong> atas
                            nama
                    ...
                    <strong>Jenis Kontrak</strong> : Lump Sum
                </td>
            </tr>
            ...
            <tr>
                <td style="width: 50%; text-align: center; vertical-align: top;">
                    <strong>Untuk dan Atas Nama<br>Pejabat Penandatanganan Kontrak<br>Prasarana Strategis<br>Satuan
                        Kerja
            ...
            <div style="padding: 0.2cm">
                <ol class="syarat-list">
                    ...
                    <li>
                        ...
                        <ol class="sub-list">
                            ...
                            <li>Rincian biaya SPK sesuai dengan rincian yang tercantum dalam rekapitulasi penawaran
                                biaya.
                            </li>
                        </ol>
                    </li>
                    <li>
                        ...
                        <ol class="sub-list">
                            <li>Pejabat Penandatanganan Kontrak berhak atas kepemilikan semua barang/bahan yang terkait
                                ...
                                Penyedia Jasa berkewajiban untuk membantu secara optimal pengalihan hak kepemilikan
                                tersebut
                                kepada Pejabat Penandatanganan Kontrak dengan hukum yang berlaku; dan</li>
                            <li>Hak kepemilikan atas peralatan dan barang/bahan yang disediakan oleh Pejabat
                                Penandatanganan
                                Kontrak tetap pada Pejabat Penandatanganan Kontrak dan semua peralatan tersebut harus
                                dikembalikan kepada Pejabat Penandatanganan Kontrak pada saat SPK berakhir atau jika
                                tidak
                ...
                <ol class="syarat-list continue">
                    <li>
                        <strong>HAK KEPEMILIKAN</strong>
                        <ol class="sub-list">
                            <li>Setiap tindak yang diisyaratkan atau diperbolehkan untuk dilakukan dan setiap dokumen
                                yang
                            ...
                            <li>Wakil Sah Pejabat Penandatanganan Kontrak Adalah Ketua Tim Pelaksanaan yang
                                kewenangannya
                    ...
                    <li>
                        ...
                        <br>Penyedia Jasa Berkewajiban untuk membayar semua pajak, bea, retribusi dan pungutan lain yang
                        sah
                ...
                <div class="page-break"></div>
                    <li>
                        ...
                        <ol class="sub-list">
                            <li>SPK ini berlaku efektif pada tanggal penandatanganan oleh para pihak atau pada tanggal
                                yang
                            ...
                            <li>Apabila Penyedia jasa tidak dapat menyelesaikan pekerjaan sesuai jadwal karena keadaan
                                di
                                luar pengendaliannya dan Penyedia Jasa telah melaporkan kejadian tersebut kepada Pejabat
                                Penandatanganan Kontrak, maka Pejabat Penandatanganan Kontrak dapat melakukan
                                penjadwalan
                    ...
                    <li>
                        ...
                        <ol class="sub-list">
                            <li>Dalam hal diperkirakan Penyedia gagal menyelesaikan pekerjaan sampai Waktu Penyelesaian
                                Pekerjaan berakhir, namun Pejabat Penandatanganan Kontrak menilai bahwa Penyedia jasa
                                mampu
                                menyelesaikan pekerjaan, Pejabat Penandatanganan Kontrak dapat memberukan kesempatan
                                kepada
                                Penyedia Jasa untuk menyelesaikan pekerjaan;</li>
                            <li>
                                Pemberian kesempatan kepada Penyedia Jasa untuk menyelesaikan pekerjaan dimuat dalam
                                Adendum
                            ...
                            <li>Pemberian Kesempatan kepada Penyedia Jasa menyelesaikan pekerjaan dengan diikuti
                                pengenaan
                                denda keterlambatan;</li>
                            <li>
                                Pemberian Kesempatan kepada Penyedia Jasa untuk menyelesaikan pekerjaan dilaksanakan
                                dengan
                                ketentuan:
                                <ol class="sub-sub-list">
                            ...
                            <li>
                                ...
                                <ol class="sub-sub-list">
                                    <li>Semua barang dan peralatan yang mempunyai risiko tinggi terjadinya kecelakaan,
                                        ...
                                        diduga; dan terhadap kecelakaan, kerusakan, kehilangan serta risiko lain yang
                                        tidak
                                        dapat diduga; dan</li>
                                    <li>Pihak ketiga sebagai akibat kecelakaan di tempat kerjanya.</li>
                                </ol>
                            </li>
                            <li>Besarnya asuransi sudah diperhitungkan dalam penawaran dan termasuk dalam biaya SPK.
                            </li>
                        </ol>
                    </li> -->
                </ol>
                <ol class="syarat-list continue2">
                    <li>
                        ...
                        <ol class="sub-list">
                            <li>
                                Penyedia Jasa berkewajiban untuk melindungi, membebaskan dan menanggung tanpa batas
                                Pejabat
                                Penandatanganan Kontrak beserta instansinya terhadap semua bentuk tuntutan, tanggung
                                jawab,
                                kewajiban, kehilangan, kerugian, denda, gugatan atau tuntutan hukum, proses pemeriksaan
                                hukum dan biaya yang dikenakan terhadap Pejabat Penandatanganan Kontrak beserta
                                instansinya
                                (kecuali kerugian yang mendasari tuntutan tersebut disebabkan kesalahan atau kelalaian
                                berat
                                Pejabat Penandatanganan Kontrak) sehubungan dengan klaim yang timbul dari hal-hal
                                berikut
                                ...
                                <ol class="sub-sub-list">
                                    ...
                                    <li>Kehilangan atau kerusakan harta benda, cedera tubuh, sakit atau kematian pihak
                                        lain
                                    </li>
                                </ol>
                            </li>
                            <li>Terhitung sejak tanggal mulai kerja sampai dengan tanggal penandatanganan berita acara
                                serah
                                terima, semua risiko kehilangan atau kerusakan hasil pekerjaan ini merupakan risiko
                                Penyedia
                            ...
                            <li>Pertanggungan asuransi yang dimiliki oleh Penyedia Jasa dibatasi sebesar nilai pekerjaan
                                yang dilaksanakan oleh Penyedia Jasa. Pejabat Penandatanganan Kontrak dapat
                                memerintahkan
                                kepada pihak lain untuk melakukan pengawasan dan pemeriksaan atas nama pelaksanaan
                                pekerjaan
                    ...
                    <li>
                        ...
                        terhadap pelaksanaan pekerjaan yang dilaksanakan oleh Penyedia Jasa. Pejabat Penandatanganan
                        Kontrak
                ...
                <div class="page-break"></div>
                    <li>
                        ...
                        <?= normalize_syarat_umum_html($syarat_umum->laporan ?? ''); ?>
                    </li>
                </ol>
                    ...
                    <li>
                        ...
                        <ol class="sub-list">
                            <li>Kecuali SPK diputuskan lebih awal, Penyedia Jasa berkewajiban untuk memulai pelaksanaan
                                pekerjaan pada tanggal mulai kerja, serta menyelesaikan Pekerjaan selambat-lambatnya
                                pada
                            ...
                            <li>Jika Pekerjaan tidak selesai pada tanggal penyelesaian disebabkan karena kesalahan atau
                                kelalaian Penyedia Jasa maka Penyedia Jasa dikenakan sanksi berupa denda keterlambatan;
                            </li>
                            <li>Jika Keterlambatan tersebut disebabkan oleh peristiwa kompensasi maka Pejabata
                                Penandatanganan Kontrak memberikan tambahan perpanjangan waktu penyelesaian pekerjaan;
                                dan
                            </li>
                ...
                <ol class="syarat-list continue4">
                    <li>
                        ...
                        <?= normalize_syarat_umum_html($syarat_umum->tugas_tanggung_jawab ?? ''); ?>
                    </li>
                    <li>
                        ...
                        <ol class="sub-list">
                            ...
                            <li>Sebelum dilakukan serah terima pekerjaan, Pejabat Penandatanganan Kontrak dan Tim
                                Pelaksana
                                melakukan pemeriksaan terhadap hasil pekerjaan;</li>
                            <li>Pejabat Penandatanganan Kontrak dalam melakukan pemeriksaan hasil pekerjaan dapat
                                dibantu
                                oleh tim pelaksana;</li>
                            <li>Apabila terdapat kekurangan-kekurangan dan/atau cacat hasil pekerjaan, Penyedia Jasa
                                wajib
                                memperbaiki/menyelesaikannya, atas perintah Pejabat Penandatanganan Kontrak dan Tim
                                Pelaksana;</li>
                            <li>Pejabat Penandatanganan Kontrak dan Tim Pelaksana menerima hasil pekerjaan setelah
                                seluruh
                                hasil pekerjaan dilaksanakan sesuai dengan SPK; dan</li>
                            <li>Pembayaran dilakukan sebesar 100% (seratus persen) dari biaya SPK setelah pekerjaan
                                selesai.
                            </li>
                        </ol>
                    </li>
                    <li>
                        ...
                        <ol class="sub-list">
                            ...
                            <li>
                                Perubahan SPK dapat dilaksanakan dalam hal terdapat perbedaan antara kondisi lapangan
                                pada
                            ...
                            <li>Untuk kepentingan perubahan SPK, Pejabat Penandatanganan Kontrak dapat meminta
                                pertimbangan
                ...
                <ol class="syarat-list continue5">
                    <li>
                        ...
                        <ol class="sub-list">
                            ...
                            <li>Dalam Keadaan Kahar, kegagalan salah satu Pihak untuk memenuhi kewajibannya yang
                                ditentukan
                                dalam SPK bukan merupakan cedera janji atau wanprestasi apabila telah dilakukan sesuai
                                pada
                                poin a. kewajiban yang dimaksud adalah hanya kewajiban dan kinerja pelaksanaan terhadap
                                pekerjaan/bagian pekerjaan yang terdampak dan/atau akan terdampak akibat dari Keadaan
                                Kahar.
                            </li>
                        </ol>
                    </li>
                    ...
                    <li>
                        ...
                        <ol class="sub-list">
                            <li>
                                ...
                                <ol class="sub-sub-list">
                                    <li>Pejabat Penandatanganan Kontrak mengubah jadwal yang dapat memengaruhi
                                        pelaksanaan
                                        pekerjaan;</li>
                                    <li>Keterlamatan pembayaran kepada Penyedia Jasa;</li>
                                    <li>Pejabat Penandatanganan Kontrak tidak memberikan gambaran-gambaran, Kerangka
                                        Acuan
                                        Kerja dan/atau instruksi sesuai jadwal yang dibutuhkan;</li>
                                    <li>Penyedia Jasa belum bisa masuk ke lokasi sesuai jadwal;</li>
                                    <li>Pejabat Penandatanganan Kontrak memerintahkan penundaan pelaksanaan pekerjaan;
                                    </li>
                                    <li>Pejabat Penandatanganan Kontrak memerintahkan mengatasi kondisi tertentu yang
                                        tidak
                                        dapat diduga sebelumnya dan disebabkan oleh Pejabat Penandatanganan Kontrak;
                                    </li>
                                </ol>
                            </li>
                            ...
                            <li>Ganti rugi hanya dapat dibayarkan jika berdasarkan data penunjang dan perhitungan
                                kompensasi
                    ...
                    <li>
                        ...
                        <ol class="sub-list">
                            <li>Jika terjadi Peristiwa Kompensasi sehingga penyelesaian pekerjaan akan melampui tanggal
                                ...
                                Pelaksana memperpanjang tanggal penyelesaian pekerjaan secara tertulis perpanjangan
                                tanggal
                            ...
                            <li>
                                ...
                                <ol class="sub-sub-list">
                                    <li>Biaya langsung pengadaan bahan dan perlengkapan untuk pekerjaan ini, bahan dan
                                        perlengkapan ini harus diserahkan oleh Penyedia Jasa kepada Pejabat
                                        Penandatanganan
                                        Kontrak dan selanjutnya menjadi hak milik Pejabat Penandatanganan Kontrak; dan
                                    </li>
                                    <li>Biaya langsung demobilisasi Penyedia Jasa.</li>
                                </ol>
                            </li>
                            <li>Pemutusan SPK dapat dilakukan oleh Pejabat Penandatanganan Kontrak atau pihak Penyedia
                                Jasa;
                            </li>
                            <li>
                                Mengesampingkan Pasal 1266 dan Pasal 1267 Kitab Undang-undang Hukum Perdata, Pejabat
                                Penandatanganan Kontrak atau Penyedia Jasa melalui pemberitahuan tertulis dapat
                                melakukan
                                ...
                                <ol class="sub-sub-list">
                                    <li>Penyedia terbukti melakukan korupsi, kolusi dan/atau nepotisme (KKN), kecurangan
                                        ...
                                        berwenang;</li>
                                    <li>Pengaduan tentang penyimpangan prosedur, dugaan KKN dan/atau pelanggaran
                                        persaingan
                                    ...
                                    <li>Penyedia menghentikan pekerjaan dan penghentian ini tidak tercantum dalam
                                        program
                                        mutu serta tanpa persetujuan Pejabat Penandatanganan Kontrak;</li>
                                    <li>Penyedia Jasa berada dalam keadaan pailit;</li>
                                    <li>Penyedia Jasa gagal memperbaiki kinerja setelah mendapat Surat Peringatan
                                        sebanyak 3
                                        (tiga) kali;</li>
                                    ...
                                    <li>Pejabat Penandatanganan Kontrak tidak menerbitkan surat perintah pembayaran
                                        untuk
                                        pembayaran tagihan angsuran sesuai dengan yang disepakti sebagaiman tercatum
                                        dalam
                                        SPK.</li>
                                </ol>
                            </li>
                ...
                <ol class="syarat-list continue7">
                    <li>
                        ...
                        <ol class="sub-list">
                            <li>
                                ...
                                <ol class="sub-sub-list">
                                    <li>Penyedia Jasa telah mengajukan tagihan disertai laporan kemajuan hasil
                                        pekerjaan;
                                    </li>
                            ...
                            <li>Pembayaran terakhir hanya dilakukan setelah pekerjaan selesai dan Berita Acara Serah
                                Terima
                                ditandatangani;</li>
                            <li>Pejabat Penandatanganan Kontrak dalam kurun waktu 7 (tujuh) hari kerja setelah pengajuan
                                permintaan pembayaran dari Penyedia Jasa harus mengajukan Surat Permintaan Pembayaran
                                kepada
                                Pejabat Penandatanganan Surat Perintah Membayar (PPSPM);</li>
                            <li>Jika terdapat ketidaksesuaian dalam perhitungan angsuran, tidak akan menjadi alasan
                                untuk
                    ...
                    <li>
                        ...
                        <ol class="sub-list">
                            <li>Jika Pekerjaan tidak dapat diselesaikan dalam jangka waktu pelaksanaan pekerjaan karena
                                kesalahan atau kelalaian Penyedia Jasa maka Penyedia Jasa berkewajiban untuk membayar
                                denda
                                kepada Pejabat Penandatanganan Kontrak sebesar 1/1000 (satu permil) dari nilai SPK
                                (tidak
                    ...
                    <li>
                        ...
                        Penyedia Jasa menjamin bahwa tidak ada satu pun personel Pejabat Penandatanganan Kontrak telah
                        atau
