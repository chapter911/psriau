                ...
                <tbody>
                    <?php $i = 1; foreach (($data ?? []) as $item): ?>
                        ...
                        >
                            ...
                            <td class="text-center">
                                <a href="<?= site_url('admin/kontrak/simak/konstruksi/' . (int) ($item['id'] ?? 0)); ?>" class="btn btn-success btn-sm">VERIFIKASI</a>
                            </td>
                            <td class="text-center">
                                <?php if (($can_edit ?? false) === true): ?>
                                    <button
                                ...
                                <?php endif; ?>
                                <?php if (($can_import ?? false) === true): ?>
                                    <form action="<?= site_url('/admin/kontrak/simak/konstruksi/' . (int) ($item['id'] ?? 0) . '/hapus'); ?>" method="post" class="d-inline simak-delete-form" data-nomor-kontrak="<?= esc((string) ($item['nomor_kontrak'] ?? '')); ?>">
                                        <?= csrf_field(); ?>
...
<div class="modal fade" id="modal-tambah-simak" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <form id="form-tambah-simak" action="<?= site_url('admin/kontrak/simak/konstruksi/tambah'); ?>" method="post">
                <?= csrf_field(); ?>
                <div class="modal-body">
...
<div class="modal fade" id="modal-import-simak" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="<?= site_url('admin/kontrak/simak/konstruksi/import'); ?>" method="post" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <div class="modal-body">
                    <div class="alert alert-info">
                    ...
                    <div class="mb-3">
                        <a href="<?= site_url('admin/kontrak/simak/konstruksi/template'); ?>" class="btn btn-success btn-sm" target="_blank">
