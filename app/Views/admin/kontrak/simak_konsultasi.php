        ...
        <div class="float-right mr-2">
            <div class="btn-group">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" href="<?= site_url('admin/kontrak/simak/konsultasi/export/excel'); ?>">
                        <i class="fas fa-file-excel mr-2 text-success"></i> Export Excel
                    </a>
                    <a class="dropdown-item" href="<?= site_url('admin/kontrak/simak/konsultasi/export/html'); ?>">
