                        ...
                        <table class="table table-bordered table-sm" id="dynamic-items-table">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th style="width: 70px; text-align: center;">Tanya</th>
                                    <th style="width: 70px; text-align: center;">Draft</th>
...
<script>
    (function () {
            ...
            if (dynamicItemsBody) {
                ...
                var rowHtml = '<tr class="dynamic-row" data-row="0">' +
                    ...
                    '<td><select class="form-control form-control-sm row-kind" name="items[0][row_kind]" required>' +
                        '<option value="section"' + ((itemEl.getAttribute('data-row_kind') || '') === 'section' ? ' selected' : '') + '>Section</option>' +
                        '<option value="group"' + ((itemEl.getAttribute('data-row_kind') || '') === 'group' ? ' selected' : '') + '>Group</option>' +
                        ...
                        '<option value="separator"' + ((itemEl.getAttribute('data-row_kind') || '') === 'separator' ? ' selected' : '') + '>Separator</option>' +
                    '</select></td>' +
        ...
        var hasOptionalContent = function () {
            return false; // Not needed anymore with new table format
        };

        var setOptionalFieldsVisibility = function (show) {
            // Not needed anymore with new table format
        };
