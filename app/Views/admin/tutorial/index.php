...
graph TD
    ...
    B6 --> H4["Verifikasi Cepat &amp; Scanner Kamera HP: Scan QR Kode Register SIMAN, Centang Reaktif Tanpa Reload, &amp; Kalkulasi Real-time"]
                                ...
                                <ol class="pl-3 small mb-0">
                                    ...
                                    <li><strong>Dropdown Partisi Ruangan &amp; Workspace Audit:</strong>
                                        <ul class="pl-3 mt-1">
                                            ...
                                            <li><strong>Verifikasi Centang 1-Klik Tanpa Reload:</strong> Klik tombol centang hijau <i class="fas fa-check text-success"></i> pada baris barang untuk memverifikasi kondisi fisik aset sebagai <em>Sesuai &amp; Ada</em>. Seluruh metrik KPI (Target, Sesuai, Belum Dicek), persentase progress pada Dropdown Partisi Ruangan, dan kartu konteks ruangan akan langsung terkalkulasi otomatis secara real-time tanpa perlu me-reload halaman sama sekali.</li>
