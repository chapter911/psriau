...
graph TD
    ...
    B1 --> C3["Update Peruntukan Massal (Pilihan Seluruh NUP / Sebagian Rentang NUP)"]
                        ...
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body">
                                ...
                                <ol class="pl-3 small mb-0">
                                    ...
                                    <li><strong>⚡ Update Peruntukan Massal (Seluruh NUP / Sebagian Rentang NUP):</strong> Klik tombol <em>Update Peruntukan Massal (NUP)</em> untuk mengubah status peruntukan banyak barang sekaligus dalam 1 kali klik. Cukup pilih Kode Barang, lalu pilih lingkup: <strong>Seluruh NUP (Semua Unit)</strong> untuk memperbarui seluruh unit aset sekaligus secara otomatis, atau <strong>Sebagian NUP (Rentang Tertentu)</strong> untuk memasukkan batas <em>NUP Awal</em> hingga <em>NUP Akhir</em> secara spesifik, lalu pilih target peruntukan (Kantor/Mobiler).</li>
