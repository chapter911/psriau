...
graph TD
    ...
    B3 --> F2["Penerbitan Surat Pinjam Pakai BMN 3 Halaman Resmi Sesuai Standar Word contoh_spp.docx (Font Arial 12pt, Margin 2.5cm/2.0cm, Hlm 1: Kop s/d Pasal 4, Hlm 2: Pasal 5-8 &amp; TTD, Hlm 3 Landscape: Tabel 10 Kolom &amp; Rekap Total)"]
    B3 --> F3["Pembaruan Pinjaman Awal Tahun (Annual Renewal): Melanjutkan Nomor Registrasi Berjalan di Tahun Baru, Transfer Aset Otomatis, Transaksi Lama Diarsipkan 'Diperbaharui' &amp; Terbit SPP Baru"]
    B3 --> F4["Indikator Baris Merah &amp; Pemisahan Kolom: Kolom Dokumen (Cetak PDF, Upload Cepat) &amp; Kolom Aksi Operasional (Perbaharui, Kembalikan, Edit, Hapus)"]
                        ...
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body">
                                ...
                                <ol class="pl-3 small mb-0">
                                    ...
                                    <li><strong>Tata Letak Tabel 8 Kolom (Pemisahan Kolom Dokumen &amp; Aksi Operasional):</strong> Tabel disajikan dalam 8 kolom terstruktur rapi: <em>No</em>, <em>Surat Perjanjian</em>, <em>Rincian Aset BMN</em>, <em>Pegawai Peminjam</em>, <em>Masa Pinjam &amp; Keperluan</em>, <strong>Status &amp; Berkas TTD</strong>, <strong>Dokumen</strong>, dan <em>Aksi</em>.
                                        <ul class="pl-3 mt-1 mb-1">
                                            ...
                                            <li><strong>Kolom Aksi Operasional:</strong> Mengelompokkan seluruh tombol tindakan tata kelola aset BMN: tombol kuning <span class="badge badge-warning text-white px-1.5"><i class="fas fa-sync-alt mr-1"></i>Perbaharui</span> (annual renewal awal tahun), tombol hijau <span class="badge badge-success px-1.5"><i class="fas fa-undo-alt mr-1"></i>Kembalikan</span> (pengembalian aset ke gudang), tombol biru <span class="badge badge-outline-primary px-1.5"><i class="fas fa-pen"></i></span> (edit rincian data), dan tombol merah <span class="badge badge-outline-danger px-1.5"><i class="fas fa-trash-alt"></i></span> (hapus transaksi).</li>
                                        </ul>
                                    </li>
