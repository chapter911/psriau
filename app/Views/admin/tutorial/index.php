    ...
    <div class="flowchart-card role-section" data-roles="admin,all">
        ...
        <div class="flowchart-card__body">
            <div class="mermaid-container mb-4">
                <pre class="mermaid">
graph TD
    A["Kelola Master Data: Pegawai (RFID Dual-Format Reader USB 10-Digit & NFC Android Hex Converter, Masa Kerja TMT CPNS, Foto ID Card), Tanggal Merah, Struktur Organisasi, MAK, Dasar SPT"] --> B[Kelola Paket Pekerjaan SIMAK Fisik & Konsultasi]
