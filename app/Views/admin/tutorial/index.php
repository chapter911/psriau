                                ...
                                <ol class="pl-3 small mb-0">
                                    ...
                                    <li><strong>Penerbitan Surat Perjanjian Pinjam Pakai BMN (Cetak PDF 3 Halaman Sesuai Format Resmi):</strong> Klik tombol merah <em>Cetak PDF</em> pada baris transaksi untuk menerbitkan dokumen resmi format 3 halaman standar Kementerian Pekerjaan Umum secara <em>pixel-perfect</em>:
                                        <ul class="pl-3 mt-1 mb-1">
                                            ...
                                            <li><strong>Halaman 3 (Orientasi Landscape):</strong> Memuat Lampiran <em>DAFTAR BARANG MILIK NEGARA YANG DIPINJAM PAKAI</em> dalam orientasi halaman <em>Landscape A4</em> murni (tabel 10 kolom: No, Kode Barang, Nama Barang, NUP, Jenis Barang, Tahun Perolehan, Jumlah, Nilai Aset per Unit Rp, Kondisi Barang, dan Keterangan) beserta blok tanda tangan resmi PIHAK KEDUA &amp; PIHAK PERTAMA yang juga sejajar rata dan bergaris bawah. Dokumen digabungkan secara otomatis dalam satu berkas PDF tunggal (Halaman 1-2 Portrait dan Halaman 3 Landscape).</li>
