...
graph TD
    ...
    B3 --> F1["Pencatatan &amp; Ubah Pinjam Pakai: Peminjaman Multi-Barang Sekaligus (1 Orang Banyak Aset), Pilihan Kop Surat, Aturan Nomor Surat (2025 Opsional, 2026+ Wajib PS.03.01/B/Gs7/{tahun}/{001}), Deteksi Benturan Kasatker &amp; Verifikasi Aset"]
    B3 --> F2["Penerbitan Surat Pinjam Pakai BMN 3 Halaman Resmi (PDF Mixed-Orientation: Halaman 1-2 Portrait &amp; Halaman 3 Landscape Multi-Baris Tabel 10 Kolom &amp; Rekapitulasi Total, Auto-Kop &amp; Kasatker Tanggal, Delegasi TTD a.n. KPB, NIP Konsultan 'Tenaga Penunjang Kegiatan')"]
    B3 --> F3["Upload Scan Dokumen &amp; Monitoring Status (Sedang Dipinjam / Selesai Dikembalikan)"]
    B3 --> F4["Proses Pengembalian Aset Sekaligus (Update Kondisi Fisik, Catatan &amp; Pemulihan Seluruh Status Aset Induk ke Gudang)"]
                        ...
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body">
                                ...
                                <ol class="pl-3 small mb-0">
                                    ...
                                    <li><strong>Peminjaman Baru (Pinjamkan Aset - Mendukung Multi-Barang Sekaligus):</strong> Klik tombol <em>Pinjamkan Aset</em>. Sistem mendukung <strong>1 orang pegawai meminjam beberapa barang sekaligus</strong> dalam satu surat perjanjian pinjam pakai. Pilih satu atau beberapa aset BMN yang tersedia dari dropdown multi-select Select2 (aset yang sedang dipinjam aktif otomatis disaring), pilih nama pegawai peminjam dari master pegawai (nama lengkap, NIP, jabatan, dan no. HP terisi otomatis, atau isi manual jika diperlukan), tentukan <strong>Kop Surat Instansi</strong> yang ingin digunakan (default ke kop surat aktif), tentukan <strong>Nomor Surat Perjanjian Pinjam Pakai</strong>: untuk transaksi <strong>tahun 2025 boleh tidak menggunakan nomor surat (opsional, pada berkas PDF header tampil bersih tanpa titik-titik nomor surat)</strong>, sedangkan untuk transaksi <strong>tahun 2026 ke atas wajib menggunakan nomor surat</strong> dengan format baku <code>PS.03.01/B/Gs7/{tahun}/{nomor auto increment 3 digit}</code> (contoh: <code>PS.03.01/B/Gs7/2026/001</code>) yang terisi otomatis atau dapat di-refresh dengan tombol <em>Auto</em>. Masukkan tanggal pinjam, estimasi rencana pengembalian, kondisi fisik barang, dan uraian keperluan dinas. Anda juga dapat langsung mengunggah file scan PDF surat peminjaman jika dokumen fisik sudah ditandatangani. Kop surat dan nomor surat juga dapat disesuaikan kembali sewaktu-waktu melalui tombol <em>Ubah (Edit)</em>.</li>
                                    <li><strong>Penerbitan Surat Perjanjian Pinjam Pakai BMN (Cetak PDF 3 Halaman Sesuai Format Resmi):</strong> Klik tombol merah <em>Cetak PDF</em> pada baris transaksi untuk menerbitkan dokumen resmi format 3 halaman standar Kementerian Pekerjaan Umum secara <em>pixel-perfect</em>:
                                        <ul class="pl-3 mt-1 mb-1">
                                            <li><strong>Halaman 1:</strong> Memuat KOP Surat terpilih, Judul <em>SURAT PERJANJIAN PINJAM PAKAI</em>, Nomor Surat (bersih tanpa titik-titik jika nomor tidak diisi pada transaksi tahun 2025), pembukaan resmi terbilang hari dan tanggal, data lengkap PIHAK PERTAMA (Kepala Satker / Kuasa Pengguna Barang) &amp; PIHAK KEDUA (Peminjam), serta kesepakatan Pasal 1 s/d Pasal 4.</li>
                                            <li><strong>Halaman 2:</strong> Memuat ketentuan lanjutan Pasal 5 s/d Pasal 8, serta blok tanda tangan resmi PIHAK KEDUA dan PIHAK PERTAMA dengan format nama sejajar horizontal rata (satu baseline) dan bergaris bawah (<u>underline</u>).</li>
                                            <li><strong>Halaman 3 (Orientasi Landscape - Daftar Multi-Barang Lengkap):</strong> Memuat Lampiran <em>DAFTAR BARANG MILIK NEGARA YANG DIPINJAM PAKAI</em> dalam orientasi halaman <em>Landscape A4</em> murni. Jika dalam 1 surat dipinjam beberapa barang, seluruh barang ditampilkan lengkap baris per baris bernomor urut 1, 2, 3, dst. (tabel 10 kolom: No, Kode Barang, Nama Barang, NUP, Jenis Barang, Tahun Perolehan, Jumlah, Nilai Aset per Unit Rp, Kondisi Barang, dan Keterangan) beserta <strong>baris rekapitulasi Total Kuantitas dan Total Nilai Aset</strong> serta blok tanda tangan resmi PIHAK KEDUA &amp; PIHAK PERTAMA yang juga sejajar rata dan bergaris bawah. Dokumen digabungkan secara otomatis dalam satu berkas PDF tunggal (Halaman 1-2 Portrait dan Halaman 3 Landscape).</li>
