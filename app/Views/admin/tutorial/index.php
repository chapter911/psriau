                        ...
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body">
                                ...
                                <ol class="pl-3 small mb-0">
                                    ...
                                    <li><strong>Cetak PDF Seluruh Ruangan (A4 Portrait, Detail NUP Tanpa Kop &amp; Tanpa Nilai):</strong> Klik tombol merah <span class="badge badge-danger px-1">Cetak PDF Seluruh Ruangan</span> di header halaman utama DBR (<code>/admin/inventaris/dbr/cetak-pdf</code>) untuk mencetak seluruh aset berlokasi di seluruh ruangan kantor dalam format PDF resmi A4 Portrait dengan penulisan masing-masing NUP tersendiri per baris (didesain ringkas tanpa kop surat, tanpa kolom kode register, dan tanpa nilai perolehan agar berfokus murni pada inventarisasi fisik aset ruangan), header berulang otomatis antar halaman, badge kondisi fisik aset, rekapitulasi unit terdaftar, serta lembar tanda tangan Kepala Satker dan Petugas BMN.</li>
