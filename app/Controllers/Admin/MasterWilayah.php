...
class MasterWilayah extends BaseController
{
    ...
    public function kabupaten()
    {
        ...
        $items = db_connect()->table('mst_kabupaten k')
            ...
            ->orderBy('k.kode_provinsi', 'ASC')
            ->orderBy('k.kode_kabupaten', 'ASC')
            ->get()
            ->getResultArray();
    ...
    public function kecamatan()
    {
        ...
        $items = db_connect()->table('mst_kecamatan kc')
            ...
            ->orderBy('kc.kode_provinsi', 'ASC')
            ->orderBy('kc.kode_kabupaten', 'ASC')
            ->orderBy('kc.kode_kecamatan', 'ASC')
            ->get()
            ->getResultArray();
