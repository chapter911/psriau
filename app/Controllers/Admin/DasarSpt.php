...
use App\Models\MstDasarSptModel;
use CodeIgniter\HTTP\RedirectResponse;

class DasarSpt extends BaseController
{
    private const MENU_LINK = 'admin/master/dasar-spt';
    ...
    public function index()
    {
        ...
        return view('admin/master/dasar_spt', [
            'pageTitle' => 'Master Dasar SPT',
            'items' => $items,
    ...
    public function create()
    {
        ...
        if (! $this->canManageMasterData()) {
            return redirect()->to('/admin/master/dasar-spt')->with('error', 'Anda tidak memiliki akses untuk menambah data dasar SPT.');
        }
        ...
        if (! $this->validate($rules)) {
            return redirect()->to('/admin/master/dasar-spt')->withInput()->with('error', 'Isian Uraian Dasar SPT wajib diisi.');
        }

        $model = new MstDasarSptModel();
        ...
        return redirect()->to('/admin/master/dasar-spt')->with('message', 'Data dasar SPT berhasil ditambahkan.');
    }
    ...
    public function edit(int $id)
    {
        ...
        if (! $this->canManageMasterData()) {
            return redirect()->to('/admin/master/dasar-spt')->with('error', 'Anda tidak memiliki akses untuk mengubah data dasar SPT.');
        }
        ...
        if (! is_array($existing)) {
            return redirect()->to('/admin/master/dasar-spt')->with('error', 'Data dasar SPT tidak ditemukan.');
        }
        ...
        return redirect()->to('/admin/master/dasar-spt')->with('message', 'Data dasar SPT berhasil diperbarui.');
    }
    ...
    public function delete(int $id)
    {
        ...
        if (! $this->canManageMasterData()) {
            return redirect()->to('/admin/master/dasar-spt')->with('error', 'Anda tidak memiliki akses untuk menghapus data dasar SPT.');
        }
        ...
        return redirect()->to('/admin/master/dasar-spt')->with('message', 'Data dasar SPT berhasil dihapus.');
    }
