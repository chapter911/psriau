...
-- Konstruksi ID: 20  |  Nomor: SMOKE/KON/1/20260610013132
-- Konsultasi ID: 12  |  Nomor: SMOKE/KONS/1/20260610013132
-- Generated: 20260610013132
-- ============================================================
...
WHERE id = 20
  AND nomor_kontrak = 'SMOKE/KON/1/20260610013132';
...
WHERE id = 12
  AND nomor_kontrak = 'SMOKE/KONS/1/20260610013132';

-- Verify nothing remains:
SELECT 'trn_kontrak_simak' AS tbl, COUNT(*) AS remaining FROM trn_kontrak_simak WHERE nomor_kontrak = 'SMOKE/KON/1/20260610013132'
UNION ALL
SELECT 'trn_kontrak_simak_konsultasi', COUNT(*) FROM trn_kontrak_simak_konsultasi WHERE nomor_kontrak = 'SMOKE/KONS/1/20260610013132';
